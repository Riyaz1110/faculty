      ...
      <div className="flex-grow flex flex-col md:flex-row max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-12 gap-8">
        ...
        <div className="flex-1">
          <div className="flex items-center justify-between mb-6 border-b border-gray-200 pb-2">
            ...
            <Link to="/search" className="text-blue-600 hover:text-blue-800 font-medium text-sm">View All Jobs &rarr;</Link>
          </div>
        ...
        <div className="w-full md:w-80 flex flex-col gap-8">
          ...
          <div className="bg-blue-50 rounded-xl p-6 border border-blue-100 text-center shadow-sm">
            ...
            <Link to="/post-job" className="inline-block bg-blue-600 text-white px-6 py-2 rounded font-bold hover:bg-blue-700 transition w-full shadow-md">
              Post Jobs
            </Link>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link to="/article/1" className="group flex gap-4 items-start pb-4 border-b border-gray-100 last:border-0 hover:bg-gray-50 p-2 -mx-2 rounded transition">
              ...
              <div className="flex-1">
                <h4 className="font-semibold text-sm text-gray-900 group-hover:text-blue-600 transition-colors line-clamp-2 leading-snug">How to Ace Your Academic Interview in 5 Steps</h4>
            ...
            <Link to="/article/2" className="group flex gap-4 items-start pb-4 border-b border-gray-100 last:border-0 hover:bg-gray-50 p-2 -mx-2 rounded transition">
              ...
              <div className="flex-1">
                <h4 className="font-semibold text-sm text-gray-900 group-hover:text-blue-600 transition-colors line-clamp-2 leading-snug">Building a Strong Research Portfolio</h4>
            ...
            <Link to="/article/3" className="group flex gap-4 items-start pb-4 border-b border-gray-100 last:border-0 hover:bg-gray-50 p-2 -mx-2 rounded transition">
              ...
              <div className="flex-1">
                <h4 className="font-semibold text-sm text-gray-900 group-hover:text-blue-600 transition-colors line-clamp-2 leading-snug">Resume Tips for First-Time Teachers</h4>
                <p className="text-xs text-gray-500 mt-1">By CampusHire Team</p>
              </div>
            </Link>
            
            <Link to="#" className="text-blue-600 text-sm font-medium pt-2 hover:underline">View all articles &rarr;</Link>
          </div>
